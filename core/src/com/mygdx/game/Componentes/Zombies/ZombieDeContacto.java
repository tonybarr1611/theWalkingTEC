...
public class ZombieDeContacto extends DeContacto{
    ...
    public ZombieDeContacto(String nombre, String tipoApariencia, ArrayList<String> sprites, int vida, int cantidadGolpes, int nivel, int campos, int nivelAparicion, int rango){
